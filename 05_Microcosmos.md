# Chapter 5: Microcosmos - Consciousness as the Boundary
...
* **Qualia and Dynamic Equilibrium:**
    As Ken Mogi suggests, consciousness is not a static list of information but the "process of dynamic equilibrium itself" woven by metabolism and information processing in the brain.

## 5.2 The Role of the Observer
...
## 5.3 Conclusion: Fractal Inference Machine
In conclusion, the brain (consciousness) is also an "Inference Machine" trying to minimize environmental uncertainty according to the FEP (Bayesian Brain Hypothesis).
However, its singularity lies in generating uncomputable "Meaning" by intentionally incorporating "fluctuations" via Chaotic Itinerancy.
